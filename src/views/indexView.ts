export const renderIndexView = (
  ...
  const toastId = `toast-${storeId}`; // Unique ID for the toast
      ...
      <div style="display: flex; justify-content: space-between; align-items: center;">
        <div style="max-width: 70%;">
          ...
          <p style="margin: 0; font-size: 0.9em; color: #555;">
            Store ID: <a href="/${chainName}.${storeId}" style="color: #007BFF; text-decoration: none;">${storeId}</a>
            <span style="cursor: pointer;" onclick="copyToClipboard('${storeId}', '${toastId}')">
